...
training_dataset = pd.read_csv('Training.csv')#comma separted files
...
X = training_dataset.iloc[:, 0:132].values #133 columns are there
y = training_dataset.iloc[:, 132].values
...
def execute_bot():
    ...
    print("Hello !! Chatbot is here to solve your problems,Please reply with yes/Yes or no/No for the following symptoms") 
